...
PACKAGE ?= helm-external-dns
XRD_DIR := apis/externaldnses
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/externaldnses/standard.yaml
...
EXAMPLES := \
    examples/externaldnses/minimal.yaml:: \
    examples/externaldnses/standard.yaml::
...
render\:%:
	@example="examples/externaldnses/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
